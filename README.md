...
- Кнопка "Импорт/Экспорт" в верхней части - открывают диалоговое окно с выбором соответствующей операции:
	- "Импорт": поля "Название колоды", "Путь к файлу", "Кодировка"
	- "Экспорт": поля "Название файла", "Путь для сохранения"
